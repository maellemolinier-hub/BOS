...
- **Toujours donner les liens cliquables.** Chaque fois que BOS mentionne un outil, une page, un fichier ou une étape à faire (ElevenLabs, Make, HubSpot, Stripe, Agenda, fichiers Output/…), mettre le lien direct à côté. Jamais « va dans X → Y » sans le lien. *(26/09/2026)*
